...
| ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | -------------- |
| All                                             | Inconsistent/interchangeable use of Staff/Admin. These terms are used interchangeably and is not immediately obvious to the reader that they play the same role.                                                                                                      | Anas        | Clarify earlier in the document regarding the staff role or maintain consistency by only using one term over the other                                              |            |                |
| Page 77                                         | Support of wearables not previously mentioned in requirements                                                                                                                                                                                                         | Anas        | Add support of wearables to requirements or remove wearables support from this section                                                                              |            |                |
