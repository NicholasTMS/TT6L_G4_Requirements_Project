...
| Req ID/Page No.                                 | Validation and Defect Description                                                                                                                                                                                                                                     | Detected By | Comment/Suggested Fix                                                                                                                                               | Session ID | Severity (1–5) |
| ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | -------------- |
| All                                             | Inconsistent/interchangeable use of Staff/Admin. These terms are used interchangeably and is not immediately obvious to the reader that they play the same role.                                                                                                      | Anas        | Clarify earlier in the document regarding the staff role or maintain consistency by only using one term over the other                                              |            | 1              |
| Page 77                                         | Support of wearables not previously mentioned in requirements                                                                                                                                                                                                         | Anas        | Add support of wearables to requirements or remove wearables support from this section                                                                              |            | 1              |
| 19                                              | Inconsistent/unclear naming of external systems. "Counselling Service" and "Medical Appointment" both refer to the same system.                                                                                                                                       | Anas        | Combine both of these Functional Requirements to avoid redundancy.                                                                                                  | S03        | 3              |
| 21                                              | No direct association between "Schedule Appointment" and "Cancel Appointment" use case to the Health Center System actor                                                                                                                                              | Anas        | Directly connect the two use cases in the diagram to show interaction between them and the Health Center System actor.                                              | S03        | 2              |
| 21, 22, 83                                      | Ambiguous use case "Login"                                                                                                                                                                                                                                            | Anas        | Properly label it as "Login to health portal system" to avoid ambiguity.                                                                                            | S03        | 1              |
| 22                                              | Related to above defect. Ambiguous use case                                                                                                                                                                                                                           | Anas        | Properly label it as "Login to health portal system" to avoid ambiguity.                                                                                            | S03        | 1              |
| 22                                              | Redundant step in main scenario for the use case table                                                                                                                                                                                                                | Anas        | Remove the duplicate step in the use case sequence.                                                                                                                 | S03        |                |
| REQ-04                                          | Cancel Appointment is not linked to G2.1 - Request Session despite it being related                                                                                                                                                                                   | Anas        | Add G2.1 to associated goals in the UC table.                                                                                                                       | S03        | 1              |
| REQ-05                                          | Reschedule Appointment is not linked to G2.1 - Request Session                                                                                                                                                                                                        | Anas        | Add G2.1 to associated goals in the UC table.                                                                                                                       | S03        | 1              |
| Page 9                                          | Missing in-scope feature from TT6L_G2_Preliminary 'Unified student dashboard...'                                                                                                                                                                                      | Anas        | Add the missing in-scope feature to the SRS                                                                                                                         | S03        | 1              |
| Page 9                                          | Missing in-scope feature from TT6L_G2_Preliminary 'Unified student dashboard...'                                                                                                                                                                                      | Anas        | Add the missing in-scope feature to the SRS                                                                                                                         | S03        |                |
| REQ-06 (page 39, 40)                            | Actors in sequence diagram and activity diagram do not match the use case table                                                                                                                                                                                       | Nicholas    | Clear the "Other Actor(s)" Section in the use case table as they are irrelevant                                                                                     | S04        | 1              |
| REQ-06 / UC06 (page 39, 40)                     | Missing exception flow for database failure in use case specification table                                                                                                                                                                                           | Nicholas    | Add exception: "[Database Unavailable] → Display 'Service temporarily unavailable'"                                                                                 | S04        | 4              |
| REQ-06 / UC06 (page 39, 40, 92(class diagram))  | Activity diagram and its description describe the input of a date range for the counselling records as "optional" but the main scenario, alternate scenario and class diagram do not describe anything regarding an optional date range input for counselling records | Nicholas    | Remove the "User specifies the date range (optional)" from the activity diagram and its description. Instead, users will see their full counselling history records | S04        | 3              |
| REQ-06/UC06 (page 40)                           | Ambiguous "Database" lifeline in sequence diagram                                                                                                                                                                                                                     | Nicholas    | Change the "Database" lifeline name to "MedicalDB" where counselling records are stored                                                                             | S04        | 3              |
| REQ-07 / UC07(page 41,42,43)                    | Missing exception flow for "Not Authenticated"                                                                                                                                                                                                                        | Nicholas    | Add an alt/exception operand "[Not Authenticated] → Prompt login" like use case specification for REQ-06 to sequence diagram                                        | S04        | 3              |
| REQ-07 / UC07(page 41,42,43)                    | Actors in sequence diagram and activity diagram do not match the use case table                                                                                                                                                                                       | Nicholas    | Clear the "Other Actor(s)" Section in the use case table as they are irrelevant                                                                                     | S04        | 1              |
| REQ-07 / UC07(page 41,42,43)                    | In sequence diagram, "Applies Filters" is lumped under the same alt block as session availability. Alternate flow 6b is also not shown                                                                                                                                | Nicholas    | Separate the filter path into its own alt                                                                                                                           | S04        | 3              |
| REQ-07 / UC07(page 41,42,43)                    | Missing exception flow if Fitness Service or FitnessDB is unavailable                                                                                                                                                                                                 | Nicholas    | Add exception: "[Database Unavailable] → Display 'Service temporarily unavailable'"                                                                                 | S04        | 4              |
| REQ-08 / UC08(page 45,46,47)                    | Missing exception flow if Fitness Service or FitnessDB is unavailable                                                                                                                                                                                                 | Nicholas    | Add exception: "[Database Unavailable] → Display 'Service temporarily unavailable'"                                                                                 | S04        | 4              |
| REQ-08 / UC08(page 45)                          | Missing exception flow for "Not Authenticated"                                                                                                                                                                                                                        | Nicholas    | Add an alt/exception operand "[Not Authenticated] → Prompt login" like use case specification for REQ-06                                                            | S04        | 3              |
| REQ-08 / UC08(page 45)                          | In use case table, main scenario step 4 has alternative scenario 4a that is not implemented in the sequence diagram                                                                                                                                                   | Nicholas    | Add an alt/exception operand to sequence diagram for schedule conflicts                                                                                             | S04        | 3              |
| REQ-08 / UC08(page 45)                          | Actors in sequence diagram and activity diagram do not match the use case table                                                                                                                                                                                       | Nicholas    | Clear the "Other Actor(s)" Section in the use case table as they are irrelevant                                                                                     | S04        | 1              |
| REQ-09 / UC09(page 48)                          | Actors in sequence diagram and activity diagram do not match the use case table                                                                                                                                                                                       | Nicholas    | Clear the "Other Actor(s)" Section in the use case table as they are irrelevant                                                                                     | S04        | 1              |
| REQ-09 / UC09(page 48)                          | Missing exception flow for "Not Authenticated"                                                                                                                                                                                                                        | Nicholas    | Add an alt/exception operand "[Not Authenticated] → Prompt login" like use case specification for REQ-06 to sequence diagram                                        | S04        | 3              |
| REQ-09 / UC09(page 48,49)                       | Missing exception flows for unavailable databases (MedicalDB, FitnessDB, WellnessDB) in use case table and sequence diagram                                                                                                                                           | Nicholas    | Add exception flows to use case table and sequence diagram                                                                                                          | S04        | 4              |
| REQ-10 / UC10(page 51,52,53)                    | Missing exception flow for "Not Authenticated"                                                                                                                                                                                                                        | Nicholas    | Add an alt/exception operand "[Not Authenticated] → Prompt login" like use case specification for REQ-06 to sequence diagram                                        | S04        | 3              |
| REQ-10 / UC10(page 51,52,53)                    | In use case table, main scenario states "Activity type (steps, workout, gym sessions)", but no clear definition of accepted goal types or valid values                                                                                                                | Nicholas    | Define valid goal types/formats (e.g., daily steps, weekly workouts) in use‑case table                                                                              | S04        | 3              |
| REQ-10 / UC10(page 51,52,53)                    | Missing exception flow if WellnessDB is unavailable                                                                                                                                                                                                                   | Nicholas    | Add exception: "[Database Unavailable] → Display 'Service temporarily unavailable'"                                                                                 | S04        | 4              |
| REQ-10 / UC10 (page 85,86)                      | Missing verification of confirmation notifications or data retrieval accuracy                                                                                                                                                                                         | Nicholas    | Add criteria like "Confirmation notification sent within 3 seconds" and "Goal present in user's profile."                                                           | S04        | 3              |
| REQ-15 / UC15 (page 64)                         | Missing Result(success) flow for [Edit Class] and [Delete Class]                                                                                                                                                                                                      | Fikrul      | Add editResult(success) and deleteResult(success) flow for [Edit Class] and [Delete Class] like [Add Class] has                                                     | S05        | 2              |
| REQ-11 / UC11 (page 85,86)                      | "Relevant to user profile" is subjective and unmeasurable.                                                                                                                                                                                                            | Nicholas    | Define relevance metrics, e.g., "AI tip matches at least 80% of user's tagged health goals."                                                                        | S05        | 2              |
| REQ-12 / UC12 (page 85,86)                      | Context and conditions for the 3-second delivery window are unclear.                                                                                                                                                                                                  | Nicholas    | "The 3-second delivery window are unclear. Specify when the timer starts (e.g., 24h prior) and what qualifies as "received.""                                       | S05        | 2              |
| REQ-13 / UC13 (page 85,86)                      | "Preferences are respected" is vague.                                                                                                                                                                                                                                 | Nicholas    | Clarify with measurable references like "Only preferred channels used per 3 tests."                                                                                 | S05        | 2              |
| REQ-14 / UC14 (page 85,86)                      | "Accurately aggregated" lacks tolerance threshold.                                                                                                                                                                                                                    | Nicholas    | Define numeric consistency, e.g., totals within ±2%.                                                                                                                | S05        | 2              |
| REQ-15 / UC15 (page 85,86)                      | "Real-time effect" isn't quantified.                                                                                                                                                                                                                                  | Nicholas    | Set timing expectations, e.g., UI reflects admin changes within 5 seconds.                                                                                          | S05        | 2              |
| REQ-16 / UC16 (page 85,86)                      | Duplicate language; lacks testable timing accuracy.                                                                                                                                                                                                                   | Nicholas    | Clarify "frontend reflects edits within 3 seconds of DB update."                                                                                                    | S05        | 2              |
| Section 4.7.1 - Goal (page 82, 83, 84)          | Goal entity doesn't match class diagram's name WellnessGoal and omits key fields like status or frequency                                                                                                                                                             | Nicholas    | Rename to "WellnessGoal" and list attributes like status, currentProgress                                                                                           | S06        | 4              |
| Section 4.7.1 - AI_Tip (page 82, 83, 84)        | AI_Tip entity not modeled anywhere in the class diagram, even though it's described and clearly functional                                                                                                                                                            | Nicholas    | Either add an AITip class or update the logical DB section to reflect where AI tips are generated and stored                                                        | S06        | 4              |
| Section 4.7 (page 82, 83, 84)                   | FitnessSession entity is named FitnessClass which is unlike use case names and class diagram.                                                                                                                                                                         | Nicholas    | Rename FitnessClass entity to FitnessSession for clarity                                                                                                            | S06        | 2              |
...
| ------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------- | ---------- | -------------- |
| page 23                         | Activation bar for UC01 sequence diagram does not align with incoming synchronous message or extend through reply to UI.    | Anas        | Adjust activation bar to touch the message arrow and extend through reply to properly represent execution duration per UML | S03        | 1              |
| page 23                         | In sequence diagram, "Student" lifeline uses rectangular block, not actor icon.                                             | Anas        | Replace "Student" lifeline with actor icon to ensure clarity with external system boundary object                          | S03        | 2              |
| page 26                         | In sequence diagram, "Student" lifeline uses rectangular block, not actor icon.                                             | Anas        | Replace "Student" lifeline with actor icon to ensure clarity with external system boundary object                          | S03        | 2              |
| page 29                         | In sequence diagram, "Student" lifeline uses rectangular block, not actor icon.                                             | Anas        | Replace "Student" lifeline with actor icon to ensure clarity with external system boundary object                          | S03        | 2              |
| page 36                         | In sequence diagram, "Student" lifeline uses rectangular block, not actor icon.                                             | Anas        | Replace "Student" lifeline with actor icon to ensure clarity with external system boundary object                          | S03        | 2              |
| REQ-06 (page 40)                | In sequence diagram, "Student" lifeline uses rectangular block, not actor icon.                                             | Nicholas    | Replace "Student" lifeline with actor icon to ensure clarity with external system boundary object                          | S04        | 2              |
| REQ-06 (page 40)                | Activation bar on "Counselling Module" does not begin at incoming synchronous message or extend through reply to UI         | Nicholas    | Adjust execution bar to touch the message arrow and extend through reply to properly represent execution duration per UML  | S04        | 1              |
| REQ-07 (page 43)                | In sequence diagram, "Student" lifeline uses rectangular block, not actor icon.                                             | Nicholas    | Replace "Student" lifeline with actor icon to ensure clarity with external system boundary object                          | S04        | 2              |
| REQ-08(page 45)                 | Inconsistent terminology: "Fitness Class" vs "Fitness Session" used interchangeably across use case table and diagrams      | Nicholas    | Standardize terminology across all sections and diagrams (Fitness session is preferred)                                    | S04        | 1              |
| REQ-08(page 46)                 | In sequence diagram, "Student" lifeline uses rectangular block, not actor icon.                                             | Nicholas    | Replace "Student" lifeline with actor icon to ensure clarity with external system boundary object                          | S04        | 2              |
| REQ-09(page 48,49)              | In sequence diagram, "Student" lifeline uses rectangular block, not actor icon.                                             | Nicholas    | Replace "Student" lifeline with actor icon to ensure clarity with external system boundary object                          | S04        | 2              |
| REQ-09(page 48,49)              | Inconsistent terminology: "Wellness Goals database" vs "WellnessDB" used interchangeably across use case table and diagrams | Nicholas    | Standardize terminology across all sections and diagrams (WellnessDB is preferred)                                         | S04        | 1              |
| page 61, 64                     | In sequence diagram, "Admin" lifeline uses rectangular block, not actor icon.                                               | Fikrul      | Replace "Admin" lifeline with actor icon to ensure clarity with external system boundary object                            | S05        | 2              |
| page 67                         | In sequence diagram, "Staff" lifeline uses rectangular block, not actor icon.                                               | Fikrul      | Replace "Staff" lifeline with actor icon to ensure clarity with external system boundary object                            | S05        | 2              |
| page 78                         | Typo for "enrollment" for PR-02                                                                                             | Anas        | Correct the spelling to enrollment.                                                                                        | S06        | 1              |
| Section 4.7 (page 82, 83, 84)   | Feedback entity is described in DB section but not found in class diagram                                                   | Nicholas    | Add Feedback class in UML or remove it if deprecated                                                                       | S06        | 2              |
| Section 4.7.4 (page 82, 83, 84) | RBAC roles like Counsellor not reflected anywhere in class diagram or anywhere else                                         | Nicholas    | Remove this mention frm 4.7.4 and add Student role                                                                         | S06        | 2              |
| page 83                         | Grammatical error "View Gym Available Sessions"                                                                             | Anas        | Change to "View Available Gym Sessions"                                                                                    | S07        | 1              |
| page 14,15,16,90                | Duplicate acronyms listed in two tables with slight variations                                                              | Nicholas    | Merge both tables into one; use consistent definitions per IEEE glossary                                                   | S07        | 2              |
| 84                              | Grammatical errors in Entry and Exit criteria tables                                                                        | Anas        | Correct the grammatical errors                                                                                             | S07        | 1              |
...
| C02         | Disagreement on content defect regarding no mention of wearables support in the requirements. | Anas says that wearable support needs to be mentioned in the requirements as it is mentioned in the interface requirements. Nicholas disagrees and says it is not a defect                | Developers, Students  | S06        |
| C03         | Disagreement on scope of a use case                                                           | Nicholas believes that the option to apply date range filter when viewing counselling records is beyond the project scope. Anas disagrees and believes that it is implied in the use case | Developers, Students  | S04        |
...
### Roles in Requirements Validation, Negotiation & Management

| Student Name  | Primary Responsibility       | No. of Sessions Participated |
| ------------- | ---------------------------- | ---------------------------- |
| Muhammad Anas | Moderator, Inspector, Reader | 7                            |
| Nicholas      | Inspector, Reader            | 7                            |
| Fikrul        | Inspector, Reader            | 7                            |
...
<figure>
<img src="./images/media/usecasediagram.png"
...
|                         | 1.2         | Name: View Fitness Session Including Gender Specific Options                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **Management**          | 2.1         | Author(s): Mohammed Aamena Mohammed Abdulkarem                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|                         | 2.2         | Version: 1.0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Context**             | 3.1         | Source(s): Questionnaire (Microsoft Forms)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Use Case Definition** | 4.1         | Short Description: Enables a student to view real-time fitness session availability through the Campus Wellness Portal, including capacity, timing, and gender-specific constraints.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|                         | 4.2         | Associated Goal(s): <br>- G3.2 -- Gym Schedules                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|                         | 4.3         | Primary Actor(s): Student                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|                         | 4.4         | Other Actor(s): -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|                         | 4.5         | Precondition(s): <br>- Student is successfully authenticated through the Campus Wellness Portal.<br>- Fitness session data is available from backend fitness services.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|                         | 4.6         | Postcondition(s): <br>- Student successfully views available sessions with real-time status and constraints.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|                         | 4.7         | Result: The system displays a list of available fitness sessions with date, time, and session type details to be viewed by the user.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|                         | 4.8         | Main Scenario: <br>1. Student accesses the "View Fitness Session Schedule" interface.<br>2. System validates user session via the Authentication Service.<br>3. System retrieves real-time fitness session schedule data, including session timing, capacity, gender restrictions, and current availability.<br>4. System displays the data in an organized calendar or list format.<br>5. Student applies filters (e.g., by date, gender, session type) to narrow down the displayed options _(optional)_.<br>6. System processes the filters and retrieves updated session data.<br>7. System reviews the filtered sessions and optionally selects a session to book, triggering UC08: Book Fitness Class. |
|                         | 4.9         | Alternative Scenario(s): <br>- 3a. No Filters Applied<br> 5a1. System defaults to displaying all sessions scheduled within the current week.<br><br>- 6a. No Sessions Available<br> 6a1. System displays: "No available sessions at this time."<br><br>- 6b. Filtered Results Yield No Matches<br> 6b1. System displays: "No sessions match your selected criteria. Please adjust filters and try again."                                                                                                                                                                                                                                                                            |
|                         |4.10         | Exception Scenario(s): <br>- 2a. Not Authenticated → System prompts student to log in  <br>  FitnessDB unavailable: System will display an error message stating, “Service temporarily unavailable. Please try again later”.|

: []{#_Toc199101184 .anchor}Table 4.7 - View Fitness Session Including Gender Specific Options
Case
...
|                         | 4.3         | Primary Actor(s): Student                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|                         | 4.4         | Other Actor(s): -                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|                         | 4.5         | Precondition(s): <br>- Student is authenticated via the Campus Wellness Portal.<br>- Real-time fitness session schedule is accessible.                                                                                                                                                                                                                                                                                                                                    |
...
|                         | 4.8         | Main Scenario: <br>1. Student accesses the "Book Fitness Session" interface.<br>2. System displays current sessions, including time, location, and capacity.<br>3. Student selects a desired session.<br>4. System checks for availability and any scheduling conflicts.<br>5. If valid, system registers the student and updates the session list.<br>6. Notification Service sends a booking confirmation via email.<br>7. System displays a success message to the student. |
|                         | 4.9         | Alternative Scenario(s): <br>- 3a. Class Full:<br> 3a1. System notifies: "Session is full -- join waitlist?"<br> 3a2. Student may choose to join the waitlist.<br>- 4a. Schedule Conflict:<br> 4a1. System alerts user about the conflict with an existing booking.   |                                                                                                                                                                                                    |
|                         | 4.10       | Exception Scenario(s): <br>- 2a. Not Authenticated:<br>
 2a1. System prompts student to log in.<br> Database Unavailable:
 System displays: “Service temporarily unavailable. Please try again later.”                                                                                                                                                                                                        |
